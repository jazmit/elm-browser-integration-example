...
Elm.BrowserIntegrationExample = Elm.BrowserIntegrationExample || {};
Elm.BrowserIntegrationExample.make = function (_elm) {
   "use strict";
   _elm.BrowserIntegrationExample = _elm.BrowserIntegrationExample || {};
   if (_elm.BrowserIntegrationExample.values)
   return _elm.BrowserIntegrationExample.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "BrowserIntegrationExample",
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $Graphics$Input$Field = Elm.Graphics.Input.Field.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var initialLocation = _P.portIn("initialLocation",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
      v);
   });
   var name = $Signal.channel(_U.replace([["string"
                                          ,initialLocation]],
   $Graphics$Input$Field.noContent));
   var location = _P.portOut("location",
   ...
   "Type here"),
   $Signal.subscribe(name));
   _elm.BrowserIntegrationExample.values = {_op: _op
                                           ,name: name
                                           ,main: main};
   return _elm.BrowserIntegrationExample.values;
};
